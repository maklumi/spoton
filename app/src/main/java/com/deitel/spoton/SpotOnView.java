...
/**
 * Created by Maklumi on 18-03-16.
 */
public class SpotOnView extends View {
    ...
    }//initializeSoundEffects(Context context)
        ...
        spot.animate().x(x2).y(y2).scaleX(SCALE_X).scaleY(SCALE_Y)
                ...
                new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        }//endif - (!gamePaused && spots.contains(spot))
    ...
    private void touchedSpot(ImageView spot) {
        ...
        if (spotsTouched % NEW_LEVEL == 0) {
            ...
            }//endif - (livesLinearLayout.getChildCount() < MAX_LIVES)
        }//endif - (spotsTouched % NEW_LEVEL == 0)

        displayScores(); //update score/level on the screen

        if (!gameOver)
            addNewSpot(); //add another untouched spot
    }//touchedSpot(ImageView spot)
    ...
    public void missedSpot(ImageView spot) {
        ...
        }//endif - (livesLinearLayout.getChildCount() == 0)
        //remove one life
        else {
        ...
        }//endelse - (livesLinearLayout.getChildCount() == 0)
    }//missedSpot(ImageView spot)
 ...
 * furnishing, performance, or use of these program.
} */
